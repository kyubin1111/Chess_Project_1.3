...
import static com.kyubin.chess.functions.PieceFunctions.getObject;
import static com.kyubin.chess.functions.PieceFunctions.removePiece;
...
public class MoveFake {
    ...
    public static ChessGame MovePiece2(XY xy, XY xy_now, ChessGame chessGame, PromotionType promotionType) {
        ...
        if(promotionType!=PromotionType.NONE&&object_type.contains("pawn")&&xy_now.y==(is_white?1:8)){
            addPieceFake(is_white?"white_":"black_"+promotionType.toString(),xy_now,chessGame);
            ...
            chessGame.game.add(new MoveTo(xy,xy_now,enemy_type,is_white?"white_pawn":"black_pawn",false,false,false,getObject(xy,chessGame),new ArrayList<>()));
            ...
            chessGame.game.add(new MoveTo(xy,xy_now,enemy_type,object_type,is_king_side_castling,is_queen_side_castling,
                    is_en_passant,getObject(xy,chessGame),PieceFunctions.isPieceGoThere(xy_now,object_type,chessGame)));
